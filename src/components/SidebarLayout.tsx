...
export default function SidebarLayout({ children }: SidebarLayoutProps) {
  ...
  return (
    <div className="flex h-full min-h-0 w-full overflow-hidden bg-sidebar text-sidebar-foreground">
      {/* Sidebar */}
      <div className="flex h-full min-h-0 w-full flex-col border-r border-sidebar-border bg-sidebar">
        {/* Header */}
