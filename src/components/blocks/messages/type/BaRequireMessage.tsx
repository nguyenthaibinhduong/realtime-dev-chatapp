...
import { FileText, ExternalLink, Calendar, Users, CheckCircle2, List } from "lucide-react";
                            ...
                            <div className="flex items-start justify-between gap-2">
                                <div className="flex items-center gap-2 flex-1 min-w-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="text-sm font-semibold text-white">BA Requirement</h3>
                                        {projectName && (
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-[10px] text-gray-400 pt-1">
                                    ...
                                    {relatedMessages.length > 0 && (
                                        <Badge variant="outline" className="h-5 text-[9px] border-blue-600 text-blue-400">
                        ...
                        <DialogTitle className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <div className="text-xl font-bold text-white flex items-center gap-2">
                                    BA Requirement
                                    <Badge variant="outline" className="ml-2 bg-blue-500/10 border-blue-500/50 text-blue-400 text-xs">
                                        {message.id}
                                    </Badge>
                                </div>
                                {projectName && (
                    ...
                    <div className="overflow-y-auto max-h-[calc(90vh-120px)] space-y-5 mt-4 pr-2">
                        ...
                        <div className="bg-gradient-to-br from-gray-900/80 to-gray-950/80 border border-blue-500/30 rounded-xl p-4 shadow-lg">
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-4 pb-4 border-b border-blue-500/20">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-xs font-medium text-gray-400 uppercase tracking-wide">Người tạo</div>
                                ...
                                {assigneeUsers.length > 0 && (
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <div className="flex-1 min-w-0">
                                            <div className="text-xs font-medium text-gray-400 uppercase tracking-wide">Phụ trách</div>
                                            <div className="text-xs font-semibold text-blue-400">{assigneeUsers.length} người</div>
                                        </div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 pb-2 border-b border-blue-500/20">
                                ...
                                <h3 className="text-base font-bold text-white uppercase tracking-wide">Danh sách yêu cầu</h3>
                                <Badge variant="outline" className="ml-auto bg-blue-500/10 border-blue-500/50 text-blue-400">
                                    {requirements.length}
                                </Badge>
                            </div>
                                ...
                                <div className="p-5 space-y-3">
                                    {requirements.map((req: string, idx: number) => (
                                        <div key={idx} className="flex items-start gap-3 group">
                                            ...
                                            <p className="text-sm text-gray-200 leading-relaxed flex-1 pt-0.5">{req}</p>
                                        </div>
                                    ))}
                                </div>
                            </Card>
                        ...
                        {relatedMessages.length > 0 && (
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 pb-2 border-b border-cyan-500/20">
                                    ...
                                    <h3 className="text-base font-bold text-white uppercase tracking-wide">Tin nhắn liên quan</h3>
                                    <Badge variant="outline" className="ml-auto bg-cyan-500/10 border-cyan-500/50 text-cyan-400">
                                ...
                                <div className="grid gap-2">
                                    {relatedMessages.map((msgId: string, idx: number) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                <div className="text-sm font-semibold text-cyan-400">Tin nhắn #{msgId}</div>
                                            </div>
